# Modified from Pennylane-Qiskit code, original license follows
...
class AQTDevice(QiskitDevice):
    ...
    short_name = "qiskit.AQT"

    def __init__(self, wires, provider=None, backend="aqt_qasm_simulator_noise_1", shots=1024, **kwargs):
        # Connection to AQT
        #connect(kwargs)
        # get a provider
